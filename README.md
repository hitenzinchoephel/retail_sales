...
## Analyzing the datasets( SQL - PostgreSQL)
...
```sql
    ...
    WHERE rn_asc = 1;
```
#### Q.4 What is the average sales revenue generated by each category ?.
```sql
      select 
      	category,
...
```
#### Average Sales revenue generated by categories. 
![My Project Logo](img/average_sales_cat.png)
...
![My Project Logo](img/yoy_growth.png)
...
#### Q.11 Find monthly sales revenue generated by each year. [2019-2023]
```sql
...
```
![Monthly Sales](img/monthly_sales.png)
...
## Technical details
##### Datasets
* Analyzed datasets containing 9969 rows and 9 columns.
* Date ranges from 2019-2023
* Analyzed 8 categorical items and customers from 98 cities.
